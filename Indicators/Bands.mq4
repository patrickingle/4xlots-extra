   ...
   for(i=pos; i<rates_total && !IsStopped(); i++)
     {
      ...
      //---
      /**
       * Added by https://4xlots.com
       */
      
      GlobalVariableSet("StdDevBand",ExtStdDevBuffer[i]);
      GlobalVariableSet("LowerBand",ExtLowerBuffer[i]);
      GlobalVariableSet("UpperBand",ExtUpperBuffer[i]);
     }
